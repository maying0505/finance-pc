...
class Main extends React.Component {
    ...
    columns = [
        ...
        {
            title: '1-5天流失用户数/老用户/流失率',
            dataIndex: 'chumUser1to5',
        },
        {
            title: '6-10天流失用户数/老用户/流失率',
            dataIndex: 'chumUser6to10',
        },
        {
            title: '11-15天流失用户数/老用户/流失率',
            dataIndex: 'chumUser11to15',
        },
        {
            title: '16-30天流失率用户数/老用户/流失率',
            dataIndex: 'chumUser16to30',
        },
        {
            title: '30天+流失用户数/老用户/流失率',
            dataIndex: 'chumUser30',
        },
    ];
    ...
    _fetchData = async (pageNum, queryObj = this.state.queryObj) => {
        try {
            ...
            const {code, message: msg, data} = await Http.chumUserList(params);
