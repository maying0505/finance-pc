...
import './RepaymentRecordList.less';
...
class Main extends React.Component {
    ...
    _fetchData = async (pageNum, queryObj = this.state.queryObj) => {
        try {
            ...
            const {code, message: msg, data} = await Http.repayRecordList(params);
    ...
    _handleExport = async () => {
        try {
            ...
            const {code, message: msg, data} = await Http.repayRecordListExport({...params});
            if (code === 200) {
    ...
    render() {
        ...
        return (
            <div className='repayment-record-list'>
